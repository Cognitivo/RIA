...
Public Class CodCodigoBarra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.CodCodigoBarra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCodCodigoBarra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CodCodigoBarra = New CodCodigoBarra()
        rpt.Site = Me.Site
        Return rpt
    End Function
