...
Public Class InfProveedorCheques
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InfProveedorCheques.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfProveedorCheques.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfProveedorCheques
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfProveedorCheques = New InfProveedorCheques()
        rpt.Site = Me.Site
        Return rpt
    End Function
