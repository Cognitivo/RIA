...
Public Class VentasListaPrecio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentasListaPrecio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasListaPrecio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasListaPrecio = New VentasListaPrecio()
        rpt.Site = Me.Site
        Return rpt
    End Function
