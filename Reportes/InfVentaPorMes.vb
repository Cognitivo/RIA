...
Public Class InfVentaPorMes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfVentaPorMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfVentaPorMes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfVentaPorMes = New InfVentaPorMes()
        rpt.Site = Me.Site
        Return rpt
    End Function
