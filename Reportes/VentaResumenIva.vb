...
Public Class VentaResumenIva
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentaResumenIva.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentaResumenIva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentaResumenIva = New VentaResumenIva()
        rpt.Site = Me.Site
        Return rpt
    End Function
