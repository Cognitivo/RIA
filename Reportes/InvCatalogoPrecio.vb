...
Public Class InvCatalogoPrecio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvCatalogoPrecio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvCatalogoPrecio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvCatalogoPrecio = New InvCatalogoPrecio()
        rpt.Site = Me.Site
        Return rpt
    End Function
