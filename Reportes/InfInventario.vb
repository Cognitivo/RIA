...
Public Class InfInventario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfInventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfInventario = New InfInventario()
        rpt.Site = Me.Site
        Return rpt
    End Function
