...
Public Class ComprasCdCLinealRT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ComprasCdCLinealRT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprasCdCLinealRT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasCdCLinealRT = New ComprasCdCLinealRT()
        rpt.Site = Me.Site
        Return rpt
    End Function
