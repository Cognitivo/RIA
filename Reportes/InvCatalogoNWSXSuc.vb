...
Public Class InvCatalogoNWSXSuc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvCatalogoNWSXSuc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvCatalogoNWSXSuc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvCatalogoNWSXSuc = New InvCatalogoNWSXSuc()
        rpt.Site = Me.Site
        Return rpt
    End Function
