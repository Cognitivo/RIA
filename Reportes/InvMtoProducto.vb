...
Public Class InvMtoProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvMtoProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvMtoProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvMtoProducto = New InvMtoProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
