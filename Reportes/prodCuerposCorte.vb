...
Public Class prodCuerposCorte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.prodCuerposCorte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprodCuerposCorte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As prodCuerposCorte = New prodCuerposCorte()
        rpt.Site = Me.Site
        Return rpt
    End Function
