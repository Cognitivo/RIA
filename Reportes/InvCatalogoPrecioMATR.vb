...
Public Class InvCatalogoPrecioMATR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvCatalogoPrecioMATR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvCatalogoPrecioMATR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvCatalogoPrecioMATR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvCatalogoPrecioMATR = New InvCatalogoPrecioMATR()
        rpt.Site = Me.Site
        Return rpt
    End Function
