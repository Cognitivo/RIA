...
Public Class VentasBreakeven
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentasBreakeven.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasBreakeven
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasBreakeven = New VentasBreakeven()
        rpt.Site = Me.Site
        Return rpt
    End Function
