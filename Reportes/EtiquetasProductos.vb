...
Public Class EtiquetasProductos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.EtiquetasProductos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetasProductos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetasProductos = New EtiquetasProductos()
        rpt.Site = Me.Site
        Return rpt
    End Function
