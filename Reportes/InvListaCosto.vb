...
Public Class InvListaCosto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvListaCosto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvListaCosto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvListaCosto = New InvListaCosto()
        rpt.Site = Me.Site
        Return rpt
    End Function
