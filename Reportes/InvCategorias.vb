...
Public Class InvCategorias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvCategorias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvCategorias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvCategorias = New InvCategorias()
        rpt.Site = Me.Site
        Return rpt
    End Function
