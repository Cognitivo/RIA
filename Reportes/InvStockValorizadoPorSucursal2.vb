...
Public Class InvStockValorizadoPorSucursal2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "InvStockValorizadoPorSucursal2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvStockValorizadoPorSucursal2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pmtCosto0Neg() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedInvStockValorizadoPorSucursal2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvStockValorizadoPorSucursal2 = New InvStockValorizadoPorSucursal2()
        rpt.Site = Me.Site
        Return rpt
    End Function
