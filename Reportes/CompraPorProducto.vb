...
Public Class CompraPorProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.CompraPorProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompraPorProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CompraPorProducto = New CompraPorProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
