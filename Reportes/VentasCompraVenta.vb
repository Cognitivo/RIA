...
Public Class VentasCompraVenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentasCompraVenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasCompraVenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasCompraVenta = New VentasCompraVenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
