...
Public Class InvCatalogoNW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvCatalogoNW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvCatalogoNW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvCatalogoNW = New InvCatalogoNW()
        rpt.Site = Me.Site
        Return rpt
    End Function
