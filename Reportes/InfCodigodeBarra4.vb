...
Public Class InfCodigodeBarra4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfCodigodeBarra4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfCodigodeBarra4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfCodigodeBarra4 = New InfCodigodeBarra4()
        rpt.Site = Me.Site
        Return rpt
    End Function
