...
Public Class VentaListaPrecioDia
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "VentaListaPrecioDia.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentaListaPrecioDia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentaListaPrecioDia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentaListaPrecioDia = New VentaListaPrecioDia()
        rpt.Site = Me.Site
        Return rpt
    End Function
