...
Public Class InfInventario1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfInventario1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfInventario1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfInventario1 = New InfInventario1()
        rpt.Site = Me.Site
        Return rpt
    End Function
