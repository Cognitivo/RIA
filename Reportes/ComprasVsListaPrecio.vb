...
Public Class ComprasVsListaPrecio
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ComprasVsListaPrecio.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ComprasVsListaPrecio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprasVsListaPrecio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasVsListaPrecio = New ComprasVsListaPrecio()
        rpt.Site = Me.Site
        Return rpt
    End Function
