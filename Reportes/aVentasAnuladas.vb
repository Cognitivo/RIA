...
Public Class aVentasAnuladas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.aVentasAnuladas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedaVentasAnuladas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As aVentasAnuladas = New aVentasAnuladas()
        rpt.Site = Me.Site
        Return rpt
    End Function
