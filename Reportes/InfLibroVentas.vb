...
Public Class InfLibroVentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfLibroVentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfLibroVentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfLibroVentas = New InfLibroVentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
