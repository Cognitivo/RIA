...
Public Class InfFacturaPagar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfFacturaPagar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfFacturaPagar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfFacturaPagar = New InfFacturaPagar()
        rpt.Site = Me.Site
        Return rpt
    End Function
