...
Public Class ProdProduccionMATR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ProdProduccionMATR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProdProduccionMATR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProdProduccionMATR = New ProdProduccionMATR()
        rpt.Site = Me.Site
        Return rpt
    End Function
