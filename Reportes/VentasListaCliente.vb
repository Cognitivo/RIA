...
Public Class VentasListaCliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentasListaCliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasListaCliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasListaCliente = New VentasListaCliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
