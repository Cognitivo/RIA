...
Public Class VentasResumenCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentasResumenCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasResumenCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasResumenCaja = New VentasResumenCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
