...
Public Class ComprasListadoOC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ComprasListadoOC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprasListadoOC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasListadoOC = New ComprasListadoOC()
        rpt.Site = Me.Site
        Return rpt
    End Function
