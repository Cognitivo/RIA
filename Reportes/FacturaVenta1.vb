...
Public Class FacturaVenta1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.FacturaVenta1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacturaVenta1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacturaVenta1 = New FacturaVenta1()
        rpt.Site = Me.Site
        Return rpt
    End Function
