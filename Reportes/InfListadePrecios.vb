...
Public Class InfListadePrecios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfListadePrecios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfListadePrecios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfListadePrecios = New InfListadePrecios()
        rpt.Site = Me.Site
        Return rpt
    End Function
