...
Public Class ContaLibroMayor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ContaLibroMayor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedContaLibroMayor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ContaLibroMayor = New ContaLibroMayor()
        rpt.Site = Me.Site
        Return rpt
    End Function
