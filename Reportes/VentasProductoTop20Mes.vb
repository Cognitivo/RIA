...
Public Class VentasProductoTop20Mes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "VentasProductoTop20Mes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentasProductoTop20Mes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasProductoTop20Mes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasProductoTop20Mes = New VentasProductoTop20Mes()
        rpt.Site = Me.Site
        Return rpt
    End Function
