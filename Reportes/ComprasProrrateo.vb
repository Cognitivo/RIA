...
Public Class ComprasProrrateo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ComprasProrrateo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NUMCOMPRA() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedComprasProrrateo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasProrrateo = New ComprasProrrateo()
        rpt.Site = Me.Site
        Return rpt
    End Function
