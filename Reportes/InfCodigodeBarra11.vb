...
Public Class InfCodigodeBarra1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfCodigodeBarra1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfCodigodeBarra1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfCodigodeBarra1 = New InfCodigodeBarra1()
        rpt.Site = Me.Site
        Return rpt
    End Function
