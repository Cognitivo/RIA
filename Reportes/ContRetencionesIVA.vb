...
Public Class ContRetencionesIVA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ContRetencionesIVA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedContRetencionesIVA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ContRetencionesIVA = New ContRetencionesIVA()
        rpt.Site = Me.Site
        Return rpt
    End Function
