...
Public Class InfCodigodeBarra2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfCodigodeBarra2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfCodigodeBarra2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfCodigodeBarra2 = New InfCodigodeBarra2()
        rpt.Site = Me.Site
        Return rpt
    End Function
