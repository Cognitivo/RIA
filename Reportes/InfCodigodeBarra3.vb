...
Public Class InfCodigodeBarra3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfCodigodeBarra3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfCodigodeBarra3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfCodigodeBarra3 = New InfCodigodeBarra3()
        rpt.Site = Me.Site
        Return rpt
    End Function
