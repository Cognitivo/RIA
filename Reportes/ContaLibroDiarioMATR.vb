...
Public Class ContaLibroDiarioMATR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ContaLibroDiarioMATR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ContaLibroDiarioMATR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedContaLibroDiarioMATR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ContaLibroDiarioMATR = New ContaLibroDiarioMATR()
        rpt.Site = Me.Site
        Return rpt
    End Function
