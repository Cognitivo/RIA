...
Public Class prodComponentesBarnizado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "prodComponentesBarnizado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.prodComponentesBarnizado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_EanCode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedprodComponentesBarnizado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As prodComponentesBarnizado = New prodComponentesBarnizado()
        rpt.Site = Me.Site
        Return rpt
    End Function
