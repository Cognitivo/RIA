...
Public Class InfStockdebajoMin
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfStockdebajoMin.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfStockdebajoMin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfStockdebajoMin = New InfStockdebajoMin()
        rpt.Site = Me.Site
        Return rpt
    End Function
