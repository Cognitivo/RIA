...
Public Class ComprasCostoFijo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ComprasCostoFijo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprasCostoFijo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasCostoFijo = New ComprasCostoFijo()
        rpt.Site = Me.Site
        Return rpt
    End Function
