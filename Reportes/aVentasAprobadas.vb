...
Public Class aVentasAprobadas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.aVentasAprobadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedaVentasAprobadas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As aVentasAprobadas = New aVentasAprobadas()
        rpt.Site = Me.Site
        Return rpt
    End Function
