...
Public Class ComboMasVendidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ComboMasVendidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComboMasVendidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComboMasVendidos = New ComboMasVendidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
