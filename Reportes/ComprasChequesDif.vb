...
Public Class ComprasChequesDif
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ComprasChequesDif.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprasChequesDif
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasChequesDif = New ComprasChequesDif()
        rpt.Site = Me.Site
        Return rpt
    End Function
