...
Public Class InvMtoDetProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvMtoDetProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DiaAnterior() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedInvMtoDetProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvMtoDetProducto = New InvMtoDetProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
