...
Public Class OrdenProdMatPrima
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.OrdenProdMatPrima.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdenProdMatPrima
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdenProdMatPrima = New OrdenProdMatPrima()
        rpt.Site = Me.Site
        Return rpt
    End Function
