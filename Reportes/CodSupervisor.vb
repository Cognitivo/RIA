...
Public Class CodSupervisor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.CodSupervisor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCodSupervisor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CodSupervisor = New CodSupervisor()
        rpt.Site = Me.Site
        Return rpt
    End Function
