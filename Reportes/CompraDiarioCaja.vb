...
Public Class CompraDiarioCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.CompraDiarioCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCompraDiarioCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CompraDiarioCaja = New CompraDiarioCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
