...
Public Class VentasCoGSPromedio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentasCoGSPromedio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasCoGSPromedio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasCoGSPromedio = New VentasCoGSPromedio()
        rpt.Site = Me.Site
        Return rpt
    End Function
