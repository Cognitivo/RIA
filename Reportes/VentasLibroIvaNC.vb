...
Public Class VentasLibroIvaNC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentasLibroIvaNC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasLibroIvaNC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasLibroIvaNC = New VentasLibroIvaNC()
        rpt.Site = Me.Site
        Return rpt
    End Function
