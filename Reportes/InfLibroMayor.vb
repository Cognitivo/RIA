...
Public Class InfLibroMayor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfLibroMayor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfLibroMayor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfLibroMayor = New InfLibroMayor()
        rpt.Site = Me.Site
        Return rpt
    End Function
