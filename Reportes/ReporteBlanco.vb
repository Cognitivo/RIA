...
Public Class ReporteBlanco
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ReporteBlanco.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pmtReporteName() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteBlanco
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteBlanco = New ReporteBlanco()
        rpt.Site = Me.Site
        Return rpt
    End Function
