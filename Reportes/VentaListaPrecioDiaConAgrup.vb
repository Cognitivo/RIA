...
Public Class VentaListaPrecioDiaConAgrup
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "VentaListaPrecioDiaConAgrup.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentaListaPrecioDiaConAgrup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentaListaPrecioDiaConAgrup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentaListaPrecioDiaConAgrup = New VentaListaPrecioDiaConAgrup()
        rpt.Site = Me.Site
        Return rpt
    End Function
