...
Public Class ProyeccionCobros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ProyeccionCobros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProyeccionCobros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProyeccionCobros = New ProyeccionCobros()
        rpt.Site = Me.Site
        Return rpt
    End Function
