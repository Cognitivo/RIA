...
Public Class InvStockMinimo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvStockMinimo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvStockMinimo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvStockMinimo = New InvStockMinimo()
        rpt.Site = Me.Site
        Return rpt
    End Function
