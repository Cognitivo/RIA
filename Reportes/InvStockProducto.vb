...
Public Class InvStockProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvStockProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvStockProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvStockProducto = New InvStockProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
