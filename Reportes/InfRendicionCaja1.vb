...
Public Class InfRendicionCaja1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfRendicionCaja1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfRendicionCaja1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfRendicionCaja1 = New InfRendicionCaja1()
        rpt.Site = Me.Site
        Return rpt
    End Function
