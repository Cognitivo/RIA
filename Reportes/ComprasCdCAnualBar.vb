...
Public Class ComprasCdCAnualBar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.ComprasCdCAnualBar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprasCdCAnualBar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ComprasCdCAnualBar = New ComprasCdCAnualBar()
        rpt.Site = Me.Site
        Return rpt
    End Function
