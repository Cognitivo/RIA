...
Public Class InvCategoriasNW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InvCategoriasNW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvCategoriasNW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvCategoriasNW = New InvCategoriasNW()
        rpt.Site = Me.Site
        Return rpt
    End Function
