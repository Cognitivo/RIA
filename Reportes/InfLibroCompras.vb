...
Public Class InfLibroCompras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfLibroCompras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfLibroCompras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfLibroCompras = New InfLibroCompras()
        rpt.Site = Me.Site
        Return rpt
    End Function
