...
Public Class InfCodigodeBarra5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.InfCodigodeBarra5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfCodigodeBarra5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfCodigodeBarra5 = New InfCodigodeBarra5()
        rpt.Site = Me.Site
        Return rpt
    End Function
