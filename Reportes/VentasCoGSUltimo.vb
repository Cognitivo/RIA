...
Public Class VentasCoGSUltimo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reportes.VentasCoGSUltimo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasCoGSUltimo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasCoGSUltimo = New VentasCoGSUltimo()
        rpt.Site = Me.Site
        Return rpt
    End Function
