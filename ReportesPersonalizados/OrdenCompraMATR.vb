...
Public Class OrdenCompraMATR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ReportesPersonalizados.OrdenCompraMATR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdenCompraMATR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdenCompraMATR = New OrdenCompraMATR()
        rpt.Site = Me.Site
        Return rpt
    End Function
