...
Public Class CommercioPromo
    ...
    Private Sub btnActivarPrueba_Click(sender As System.Object, e As System.EventArgs) Handles btnActivarPrueba.Click
        ...
        '    YaProboSistema = VerificarLNK("CompanyBranchModuleId", "CompanyBranchModule", "ModuleId = 1 AND CompanyBranchid", SucLinkId)
        ...
        '                        "VALUES( " & LinkID & ", 1 ,'" & FechaPromoPeriodo & "', 1);"
        ...
        '            sql = ""
        '            sql = "UPDATE LINK SET PRUEBA = 1 WHERE LINKID = 1"
        ...
        '            MessageBox.Show("Comercio Plus fue habilitado con Exito, Ahora puede empezar a Probarlo por 15 Días!!!", "Pos Express", MessageBoxButtons.OK, MessageBoxIcon.Information)
