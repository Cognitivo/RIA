...
Public Class ProduccionPromo
    ...
    Private Sub btnActivarPrueba_Click(sender As System.Object, e As System.EventArgs) Handles btnActivarPrueba.Click
        ...
        '    YaProboSistema = VerificarLNK("CompanyBranchModuleId", "CompanyBranchModule", "ModuleId = 4 AND CompanyBranchid", SucLinkId)
        ...
        '                        "VALUES( " & LinkID & ", 4 ,'" & FechaPromoPeriodo & "', 1);"
        ...
        '            sql = ""
        '            sql = "UPDATE LINK SET PRUEBA = 1 WHERE LINKID = 6"
        ...
        '            MessageBox.Show("Produccion Lite fue habilitado con Exito, Ahora puede empezar a Probarlo por 15 Días!!!", "Pos Express", MessageBoxButtons.OK, MessageBoxIcon.Information)
