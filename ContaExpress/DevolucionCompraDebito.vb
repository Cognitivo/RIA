...
Public Class DevolucionCompraDebito
    ...
    Private Property DescSINO As String
    ...
    Private Sub DevolucionCompra_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Me.TIPOCOMPROBANTEDEBITOTableAdapter.Fill(Me.DsDevolucionCompra.TIPOCOMPROBANTEDEBITO)

        dtIva = IvaDevCompraTableAdapter1.GetData()

        InicializaFechaFiltro()
        Me.DEVOLUCIONDEBITOCOMPRATableAdapter.Fill(Me.DsDevolucionCompra.DEVOLUCIONDEBITOCOMPRA, FechaFiltro1, FechaFiltro2)

        Try
            DEVOLUCIONDEBITOCOMPRADETALLETableAdapter.Fill(DsDevolucionCompra.DEVOLUCIONDEBITOCOMPRADETALLE, DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCION").Value)
    ...
    Private Sub NuevoPictureBox_Click(sender As System.Object, e As System.EventArgs) Handles NuevoPictureBox.Click
        ...
        Else
            Habilita()
            DEVOLUCIONDEBITOCOMPRABindingSource.AddNew()

            Try
                DEVOLUCIONDEBITOCOMPRADETALLETableAdapter.Fill(DsDevolucionCompra.DEVOLUCIONDEBITOCOMPRADETALLE, 0)
            Catch ex As Exception
            End Try
            ...
            AccBtNuevo = 1 : TxtEstado.Text = "3" : cbxTipoItem.Text = "Producto" : tbxSeCobro.Text = "" : cbxDescartar.Text = "Aumentar el Stock" : SiDEV = 0 : AddButton.BringToFront()
            ...
            IvaIncluidoComboBox.SelectedIndex = 1
    ...
    Private Sub ObtenerConfig()
        ...
        'Try
        '    objCommand.CommandText = "SELECT CONFIG1, CONFIG2,CONFIG3, CONFIG4 FROM MODULO WHERE MODULO_ID = 29"
    ...
    Private Sub cbxTipoItem_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cbxTipoItem.SelectedIndexChanged
        If cbxTipoItem.Text <> "" Then
            If cbxTipoItem.Text = "Producto" Then
                ...
                cbxDescartar.Text = "Aumentar el Stock"
                cbxIva.Enabled = False
                txtCodigo.Focus()
            ElseIf cbxTipoItem.Text = "Item" Then
                txtCodigo.Enabled = False
                txtProductoDescripcion.Enabled = True
                cbxDescartar.Text = "NO aumentar el Stock"
                cbxIva.Enabled = True
                txtProductoDescripcion.Focus()
            End If
        End If
...
todoslosprod:
    ...
    Private Sub CantidadTextBox_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles CantidadTextBox.KeyPress
        Dim KeyAscii As Short = Asc(e.KeyChar)
        If KeyAscii = 13 Then
            txtPrecio.Focus()
        End If
    ...
    Private Sub CancelarPictureBox_Click(sender As System.Object, e As System.EventArgs) Handles CancelarPictureBox.Click
        DEVOLUCIONDEBITOCOMPRABindingSource.CancelEdit()
    ...
    Private Sub ProductosDataGridView_CellDoubleClick(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles ProductosDataGridView.CellDoubleClick
        ...
        Else
            CantidadTextBox.Text = ProductosDataGridView.CurrentRow.Cells("CANTIDADCOMPRADataGridViewTextBoxColumn").Value
        End If

        'Cantidad Real
        If IsDBNull(ProductosDataGridView.CurrentRow.Cells("CANTIDADCOMPRADataGridViewTextBoxColumn").Value) Then
            CantRealMaskedEdit.Text = 0
        Else
            CantRealMaskedEdit.Text = CInt(ProductosDataGridView.CurrentRow.Cells("CANTIDADCOMPRADataGridViewTextBoxColumn").Value) - CInt(ProductosDataGridView.CurrentRow.Cells("TOTALDEVUELTO").Value)
        End If
    ...
    Private Sub ProductosDataGridView_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles ProductosDataGridView.KeyPress
        ...
        If KeyAscii = 13 Then
            ...
            If IsDBNull(ProductosDataGridView.Rows(pos).Cells("CANTIDADCOMPRADataGridViewTextBoxColumn").Value) Then
                CantidadTextBox.Text = ""
            Else
                CantidadTextBox.Text = ProductosDataGridView.Rows(pos).Cells("CANTIDADCOMPRADataGridViewTextBoxColumn").Value
            End If
            ...
            Else
                CantRealMaskedEdit.Text = CInt(ProductosDataGridView.Rows(pos).Cells("CANTIDADCOMPRADataGridViewTextBoxColumn").Value) - CInt(ProductosDataGridView.Rows(pos).Cells("TOTALDEVUELTO").Value)
            End If
    ...
    Private Sub AddButton_Click(sender As System.Object, e As System.EventArgs) Handles AddButton.Click
        ...
        Dim Iva, Coddevlocal As Integer

        Dim Maximo As Double = w.Maximo("CODDEVOLDET", "DEVOLUCIONDEBITOCOMPRADETALLE")
        VGCodDevolucion = Maximo - 1
        ...
        If String.IsNullOrEmpty(CantidadTextBox.Text) Then
            ...
            CantidadTextBox.Focus()
            Exit Sub
        ElseIf CDec(CantidadTextBox.Text) = 0 Then
        ...
        'If CantRealMaskedEdit.Text = "" And cbxRelacionarFactura.Text = "No" Then
        '    CantRealMaskedEdit.Text = 0
        'End If

        'Try
        '    If CantRealMaskedEdit.Text <> "" And CantRealMaskedEdit.Text <> 0 Then
        '        If CDec(CantidadTextBox.Text) > CDec(CantRealMaskedEdit.Text) Then
        ...
        If cbxDescartar.Text = "NO aumenta el Stock" Then
            Descarte = "0"
            DescSINO = "NO"
        Else
            Descarte = "1"
        ...
        Dim y As Integer = DevolucionesDataGridView.RowCount
        Try
            DevolucionesDataGridView.Rows(y - 1).Cells("CODDEVOLUCION").Value = CodDevolucionTextBox.Text
        Catch ex As Exception
        End Try
        ...
        For x = 1 To x
            Try
                If IsDBNull(DetalleDevDataGridView.Rows(x - 1).Cells("DataGridViewTextBoxColumn1").Value) Then
                Else
                    If CodCodigoTextBox.Text = DetalleDevDataGridView.Rows(x - 1).Cells("DataGridViewTextBoxColumn1").Value Then
        ...
        Try
            DEVOLUCIONDEBITOCOMPRADETALLEBindingSource.AddNew()
        Catch ex As Exception
        End Try
        ...
        Try
            DetalleDevDataGridView.Rows(c - 1).Cells("CANTIDADDEVUELTADataGridViewTextBoxColumn").Value = CantidadTextBox.Text
            DetalleDevDataGridView.Rows(c - 1).Cells("IVADataGridViewTextBoxColumn").Value = Iva
            DetalleDevDataGridView.Rows(c - 1).Cells("PRECIONETODataGridViewTextBoxColumn").Value = CDec(txtPrecio.Text)
            DetalleDevDataGridView.Rows(c - 1).Cells("DESCARTARDataGridViewTextBoxColumn").Value = Descarte
            DetalleDevDataGridView.Rows(c - 1).Cells("DESCRIPCIONDataGridViewTextBoxColumn").Value = txtProductoDescripcion.Text
            DetalleDevDataGridView.Rows(c - 1).Cells("DataGridViewTextBoxColumn2").Value = Me.CodDevolucionTextBox.Text
            DetalleDevDataGridView.Rows(c - 1).Cells("EstadoGrilla").Value = 1 'Insert
            DetalleDevDataGridView.Rows(c - 1).Cells("AumentarStock").Value = DescSINO

            If cbxTipoItem.Text = "Producto" Then
                DetalleDevDataGridView.Rows(c - 1).Cells("DataGridViewTextBoxColumn1").Value = CodCodigoTextBox.Text
                DetalleDevDataGridView.Rows(c - 1).Cells("CODPRODUCTODataGridViewTextBoxColumn1").Value = CodProductoTextBox.Text
                DetalleDevDataGridView.Rows(c - 1).Cells("CODIGO").Value = txtCodigo.Text

                If cbxRelacionarFactura.Text = "Si" Then
                    DetalleDevDataGridView.Rows(c - 1).Cells("CODCOMPRADataGridViewTextBoxColumn1").Value = txtCodFacturaCompra.Text
                End If
            End If
        Catch ex As Exception
        End Try

        Coddevlocal = Me.CodDevolucionTextBox.Text
        RecorreDetalleDevolucion()
        Limpiamos()
        txtCodigo.Focus()
    ...
    Private Sub RecorreDetalleDevolucion()
        ...
        For c = 1 To c
            If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("DataGridViewTextBoxColumn1").Value) Then
                CodCodigo = ""
            Else
                CodCodigo = DetalleDevDataGridView.Rows(c - 1).Cells("DataGridViewTextBoxColumn1").Value
            End If
            If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("CODIGO").Value) Then
                CodProducto = ""
            Else
                CodProducto = DetalleDevDataGridView.Rows(c - 1).Cells("CODIGO").Value
            End If
            ...
            Else
                DetalleDevDataGridView.Rows(c - 1).Cells("CANTIDADDEVUELTADataGridViewTextBoxColumn").Value = DetalleDevDataGridView.Rows(c - 1).Cells("CANTIDADDEVUELTADataGridViewTextBoxColumn").Value
            End If

            'Total
            Total = DetalleDevDataGridView.Rows(c - 1).Cells("PRECIONETODataGridViewTextBoxColumn").Value * DetalleDevDataGridView.Rows(c - 1).Cells("CANTIDADDEVUELTADataGridViewTextBoxColumn").Value
            DetalleDevDataGridView.Rows(c - 1).Cells("SubTotal").Value = Total
            ...
            'Descarte
            If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("AumentarStock").Value) Then
            Else
                Try
                    If DetalleDevDataGridView.Rows(c - 1).Cells("AumentarStock").Value = 1 Then
                        DetalleDevDataGridView.Rows(c - 1).Cells("AumentarStock").Value = "SI"
                    ElseIf DetalleDevDataGridView.Rows(c - 1).Cells("AumentarStock").Value = 0 Then
                        DetalleDevDataGridView.Rows(c - 1).Cells("AumentarStock").Value = "NO"
                    End If
                Catch ex As Exception
                End Try
            End If
    ...
    Private Sub ElimButton_Click(sender As System.Object, e As System.EventArgs) Handles ElimButton.Click
        ...
        If IsDBNull(DetalleDevDataGridView.CurrentRow) Then
            Exit Sub
        Else
            CodigoABorrar = DetalleDevDataGridView.CurrentRow.Cells("DataGridViewTextBoxColumn2").Value
        End If
        ...
        If Existe > 0 Then
            Try
                ...
                cmd.Connection = sqlc
                sql = ""
                sql = "DELETE DEVOLUCIONDEBITOCOMPRADETALLE WHERE CODDEVOLDET = " & CodigoABorrar & ""
                cmd.CommandText = sql
                cmd.ExecuteNonQuery()
            ...
            Catch ex As Exception
                ...
                Exit Sub
            End Try
            DEVOLUCIONDEBITOCOMPRADETALLETableAdapter.Fill(DsDevolucionCompra.DEVOLUCIONDEBITOCOMPRADETALLE, DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCIONDataGridViewTextBoxColumn").Value)
    ...
    Private Sub ModificarPictureBox_Click(sender As System.Object, e As System.EventArgs) Handles ModificarPictureBox.Click
        ...
        Else
            ...
            Else
                If Not IsDBNull(DevolucionesDataGridView.CurrentRow.Cells("CODCOMPRA").Value) Then
                    Dim saldofact As Integer = w.FuncionConsulta("SUM(SALDOCUOTA)", "FACTURAPAGAR", "CODCOMPRA", DevolucionesDataGridView.CurrentRow.Cells("CODCOMPRA").Value)
                    Dim totaldev As Integer = w.FuncionConsulta("SUM(TOTALDEVOLUCION)", "DEVOLUCIONCOMPRA", "(ESTADO=1) AND CODCOMPRA", DevolucionesDataGridView.CurrentRow.Cells("CODCOMPRA").Value)
                    Dim importeCompra As Integer = w.FuncionConsulta("TOTALCOMPRA", "COMPRAS", "CODCOMPRA", DevolucionesDataGridView.CurrentRow.Cells("CODCOMPRA").Value)
                    VGCodigoCompra = DevolucionesDataGridView.CurrentRow.Cells("CODCOMPRA").Value
                    If saldofact <> 0 Then
                        VGSaldo = saldofact
                        SiDEV = 0
                    Else
            ...
            Dim EstadoDev As Integer = w.FuncionConsultaDecimal("ESTADO", "DEVOLUCIONDEBITOCOMPRA", "CODDEVOLUCION", CodDevolucionTextBox.Text)
    ...
    Private Sub GuardarPictureBox_Click(sender As System.Object, e As System.EventArgs) Handles GuardarPictureBox.Click
        ...
        EstadoDev = w.FuncionConsultaDecimal("ESTADO", "DEVOLUCIONDEBITOCOMPRA", "CODDEVOLUCION", CodDevolucionTextBox.Text)
        ...
        Existe = w.FuncionConsulta("CODDEVOLUCION", "DEVOLUCIONDEBITOCOMPRA", "CODDEVOLUCION", CDec(CodDevolucionTextBox.Text))
        ...
        For i = 0 To DevolucionesDataGridView.RowCount - 1
            If DevolucionesDataGridView.Rows(i).Cells("CODDEVOLUCION").Value = CodDev Then
                DEVOLUCIONDEBITOCOMPRABindingSource.Position = i
            End If
        Next
    ...
    Private Sub InsertaDevolucion()
        ...
        sql = ""
        sql = "INSERT INTO DEVOLUCIONDEBITOCOMPRA (CODPROVEEDOR, CODCOMPRA, CODMONEDA, CODSUCURSAL,FECHADEVOLUCION, TOTALEXENTA, TOTALIVA, TOTALDEVOLUCION, COTIZACION1, " & _
              "TOTALIVA5, TOTALIVA10, FECGRA, CODCOMPROBANTE, COBRADO,CODDEPOSITO, ESTADO,MOTIVODESCARTE, TIPODEVOLUCION,DESCONTARMONTO, NUMDEVOLUCION,SALDO) " & _
              "VALUES (" & cbxProveedor.SelectedValue & ", " & CodCompra & ", " & CmbMoneda.SelectedValue & ", " & SucCodigo & ", " & _
              ...
              DescontarMonto & ",'" & txtNroDevolucion.Text & "', " & TotalDev & ")  " & _
              "SELECT CODDEVOLUCION FROM DEVOLUCIONDEBITOCOMPRA WHERE CODDEVOLUCION = SCOPE_IDENTITY();"
    ...
    Private Sub ActualizaDevolucion()
        ...
        sql = ""
        sql = "UPDATE DEVOLUCIONDEBITOCOMPRA SET CODPROVEEDOR=" & cbxProveedor.SelectedValue & ",CODCOMPRA=" & CodCompra & ",CODMONEDA=" & CmbMoneda.SelectedValue & ",CODSUCURSAL=" & SucCodigo & "," & _
              ...
              ", NUMDEVOLUCION='" & txtNroDevolucion.Text & "'  WHERE CODDEVOLUCION=" & CDec(CodDevolucionTextBox.Text) & ""
    ...
    Private Sub ActualizaDetalleDev()
        ...
        CodDevolucionDet = DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCION").Value
        For c = 1 To c
            If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("DataGridViewTextBoxColumn1").Value) Then
                CodCodigoDet = "Null"
            Else
                CodCodigoDet = DetalleDevDataGridView.Rows(c - 1).Cells("DataGridViewTextBoxColumn1").Value
            End If

            If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("CODPRODUCTODataGridViewTextBoxColumn1").Value) Then
                CodProductoDet = "Null"
            Else
                CodProductoDet = DetalleDevDataGridView.Rows(c - 1).Cells("CODPRODUCTODataGridViewTextBoxColumn1").Value
            End If

            If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("DESCRIPCIONDataGridViewTextBoxColumn").Value) Then
                DescripItem = "Null"
            Else
                DescripItem = DetalleDevDataGridView.Rows(c - 1).Cells("DESCRIPCIONDataGridViewTextBoxColumn").Value
            End If

            If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("CODCOMPRADataGridViewTextBoxColumn1").Value) Then
                CodCompra = "Null"
            Else
                CodCompra = DetalleDevDataGridView.Rows(c - 1).Cells("CODCOMPRADataGridViewTextBoxColumn1").Value
            End If
            ...
            Try
                If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("PRECIONETODataGridViewTextBoxColumn").Value) Then
                    PrecioNetoDet = "0"
                Else
                    PrecioNetoDet = DetalleDevDataGridView.Rows(c - 1).Cells("PRECIONETODataGridViewTextBoxColumn").Value
            ...
            'Descartar
            If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("DESCARTARDataGridViewTextBoxColumn").Value) Then
                DescartarDet = "0"
            Else
                DescartarDet = DetalleDevDataGridView.Rows(c - 1).Cells("DESCARTARDataGridViewTextBoxColumn").Value
            End If

            If DetalleDevDataGridView.Rows(c - 1).Cells("EstadoGrilla").Value = 1 Then
                sql = ""
                sql = "INSERT INTO DEVOLUCIONDEBITOCOMPRADETALLE (CODDEVOLUCION, CODCODIGO, CODPRODUCTO, CANTIDADDEVUELTA, PRECIONETO, IVA,DESCARTAR,DESCRIPCION,CODCOMPRA) " & _
    ...
    Private Sub InsertaDetalleDev()
        ...
        For c = 1 To c
            ...
            If DetalleDevDataGridView.Rows(c - 1).Cells("EstadoGrilla").Value = 1 Or btduplicar = 1 Then
                sql = ""
                sql = "INSERT INTO DEVOLUCIONDEBITOCOMPRADETALLE (CODDEVOLUCION, CODCODIGO, CODPRODUCTO, CANTIDADDEVUELTA, PRECIONETO, IVA,DESCARTAR,DESCRIPCION,CODCOMPRA) " & _
                      "VALUES(" & VGCodDevolucion & ", " & CodCodigoDet & ",  " & CodProductoDet & ", " & CantidadDevueltaDet & ", " & PrecioNetoDet & ", " & _
                      IvaDet & ", " & DescartarDet & ",'" & DescripItem & "'," & CodCompra & ") "
    ...
    Private Sub ObternerDatos()
        ...
        For c = 1 To c
            ...
            If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("DESCARTARDataGridViewTextBoxColumn").Value) Then
            Else
                If DetalleDevDataGridView.Rows(c - 1).Cells("DESCARTARDataGridViewTextBoxColumn").Value = 1 Then
                    DetalleDevDataGridView.Rows(c - 1).Cells("AumentarStock").Value = "SI"
                ElseIf DetalleDevDataGridView.Rows(c - 1).Cells("DESCARTARDataGridViewTextBoxColumn").Value = 0 Then
                    DetalleDevDataGridView.Rows(c - 1).Cells("AumentarStock").Value = "NO"
                End If
            End If
    ...
    Private Sub DevolucionesDataGridView_Scroll(sender As Object, e As System.Windows.Forms.ScrollEventArgs) Handles DevolucionesDataGridView.Scroll
    ...
    Private Sub DevolucionesDataGridView_SelectionChanged(sender As Object, e As System.EventArgs) Handles DevolucionesDataGridView.SelectionChanged
        ...
        If CodDevolucionTextBox.Text <> "" Then
            Try
                ...
                ObternerDatos()
                cobrado = w.FuncionConsulta("COBRADO", "DEVOLUCIONDEBITOCOMPRA", "CODDEVOLUCION", CodDevolucionTextBox.Text)
    ...
    Private Sub ELIMINAR()
        ...
        Try
            ...
            Catch ex As Exception
            End Try
            DEVOLUCIONDEBITOCOMPRABindingSource.MoveLast()
    ...
    Private Sub EliminaRDevolucion()
        sql = ""
        sql = "DELETE FROM DEVOLUCIONDEBITOCOMPRA WHERE CODDEVOLUCION = " & CodDevolucionTextBox.Text & ""
        cmd.CommandText = sql
        cmd.ExecuteNonQuery()
    End Sub
    ...
    Private Sub EliminarDetalleDevolucion()
        ...
        Else
            sql = ""
            sql = "DELETE FROM DEVOLUCIONDEBITOCOMPRADETALLE WHERE CODDEVOLUCION = " & CodDevolucionTextBox.Text
            cmd.CommandText = sql
            cmd.ExecuteNonQuery()
        End If
    End Sub
    ...
    Private Sub BtnFiltro_Click(sender As System.Object, e As System.EventArgs) Handles BtnFiltro.Click
        FechaFiltro()
        Try
            DEVOLUCIONDEBITOCOMPRABindingSource.RemoveFilter()
            ...
            If Me.cbxDescontarMonto.Checked = True Then
                ...
                If txtNroFactura.Text <> "" Then '  Si modifico y puso Otra factura
                    ...
                    If odrDev.HasRows Then
                        ...
                        Loop
                    End If
                    sql = sql + " UPDATE DEVOLUCIONEBITOCOMPRA SET COBRADO =  1, SALDO = 0 WHERE CODDEVOLUCION = " & DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCIONDataGridViewTextBoxColumn").Value & "   "
                ...
                Else ' Tenía antes un nrofactura y ahora no, se devuelve el saldo (igual al importe) a la Devolucion
                    sql = sql + " UPDATE DEVOLUCIONDEBITOCOMPRA SET COBRADO =  0, SALDO = " & CDec(TotalMaskedEdit.Text) & " WHERE CODDEVOLUCION = " & DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCIONDataGridViewTextBoxColumn").Value & "   "
                    cmd.CommandText = sql
                    cmd.ExecuteNonQuery()
                End If
            End If
    ...
    Private Sub btnAprobar_Click(sender As System.Object, e As System.EventArgs) Handles btnAprobar.Click
        ...
        Else
            ...
            For cc = 0 To cc - 1
                ...
                AumentaStock = DetalleDevDataGridView.Rows(cc).Cells("AumentarStock").Value

                'verificamos si existe o no el producto para saber si modificamos o insertamos
                If AumentaStock = "SI" Then
                    CodProductoDev = DetalleDevDataGridView.Rows(cc).Cells("CODPRODUCTODataGridViewTextBoxColumn1").Value
                    If IsDBNull(DetalleDevDataGridView.Rows(cc).Cells("DataGridViewTextBoxColumn1").Value) Then
                        CodCodigo = "NULL"
                    Else
                        CodCodigo = DetalleDevDataGridView.Rows(cc).Cells("DataGridViewTextBoxColumn1").Value
                    End If
                    If IsDBNull(DetalleDevDataGridView.Rows(cc).Cells("CANTIDADDEVUELTADataGridViewTextBoxColumn").Value) Then
                        CantidadDev = "NULL"
                    Else
                        CantidadDev = CDec(DetalleDevDataGridView.Rows(cc).Cells("CANTIDADDEVUELTADataGridViewTextBoxColumn").Value)
            ...
            If DescontarMonto = "1" Then
                ...
                VCodCompra = w.FuncionConsultaDecimal("CODCOMPRA", "DEVOLUCIONDEBITOCOMPRA", "CODDEVOLUCION", DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCION").Value)
                ...
                If cbxRelacionarFactura.Text = "Si" Then
                    If Not IsDBNull(DevolucionesDataGridView.CurrentRow.Cells("DataGridViewTextBoxColumn3").Value) Then
                        Dim saldofact As Integer = w.FuncionConsulta("SUM(SALDOCUOTA)", "FACTURAPAGAR", "CODCOMPRA", DevolucionesDataGridView.CurrentRow.Cells("DataGridViewTextBoxColumn3").Value)
                        If saldofact <> 0 Then
                            SiDEV = 0
                        Else
                            SiDEV = 1
                ...
                If odrDev.HasRows Then
                    Do While odrDev.Read()
                        If IMPORTEDEV > 0 Then
                            ...
                            If SALDOACTUAL <> 0 Then ' se puso este IF en el caso que SiDEV=0 y por ej. una factura tenga 5 cuotas, 3 pago en efectivo y 2 quiere anular con NC. si no se pone este control igual entra para las 3 primeras cuotas ya saldadas
                                ...
                                Else ' el IMPORTEDEV es Mayor o Igual al Saldo de la Cuota o Saldo de DevolucionesXFactura
                                    sql = sql + " INSERT INTO COMPRASFORMAPAGO (CODPAGO,CODCOMPRA,CODTIPOPAGO,CODMONEDA,COTIZACION1,IMPORTE,DESTIPOPAGO,FECHAPAGO,NROCUOTA,NUMDEVOLUCION,CABPAGO,TIPOPAGO,AUTORIZADO) " & _
                                         "VALUES (" & MaxPago & "," & VCodCompra & ",5," & CmbMoneda.SelectedValue & "," & Cotizacion1 & "," & SALDOACTUAL & ",'Nota de debito',CONVERT(DATETIME,'" & Concatenar & "',103), " & _
                                         odrDev("NUMEROCUOTA") & ",'" & NumDevolucion & "'," & MaxCabPago & ",1," & UsuCodigo & ")"
                    ...
                    Loop
                End If
                sql = sql + " UPDATE DEVOLUCIONDEBITOCOMPRA SET COBRADO =  1, SALDO = 0 WHERE CODDEVOLUCION = " & DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCION").Value & "   "
    ...
    Private Sub InsertaMovProducto(ByRef CodProductoDev As String, ByRef CodCodigo As String, ByRef CantidadDev As String, ByRef tipo As String)
        ...
        If tipo = "Aprobar" Then
            sql = "INSERT INTO MOVPRODUCTO " & _
                        ...
                        "" & UsuCodigo & "," & CmbDeposito.SelectedValue & ",29,1,0," & DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCION").Value & " ) "
        Else
            sql = "INSERT INTO MOVPRODUCTO " & _
                        "(CODCODIGO,CONCEPTO,CANTIDAD,FECHAMOVIMIENTO,CODUSUARIO, CODDEPOSITO,MODULO,STOCK,COSTEABLE,MODULOTRANSID)" & _
    ...
    Private Sub Aprobar()
        Dim Actual As Integer = DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCION").Value
        sql = ""
        sql = "UPDATE DEVOLUCIONDEBITOCOMPRA SET ESTADO = 1 WHERE CODDEVOLUCION= " & Actual
    ...
    Private Sub BuscarDevolucionTextBox_TextChanged(sender As System.Object, e As System.EventArgs) Handles BuscarDevolucionTextBox.TextChanged
        Try
            Me.DEVOLUCIONDEBITOCOMPRABindingSource.Filter = "NUMDEVOLUCION LIKE '%" & BuscarDevolucionTextBox.Text & "%' OR NOMBRE LIKE '%" & BuscarDevolucionTextBox.Text & "%'"
            lblDGVCant.Text = "Cant. de Items:" & DevolucionesDataGridView.RowCount
            PintarCeldas()
        Catch ex As Exception
        End Try
        ...
        Else
            ...
            For c = 1 To c
                ...
                If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("CODPRODUCTODataGridViewTextBoxColumn1").Value) Then
                    ...
                    Exit Sub
                Else
                    CodProductoDev = DetalleDevDataGridView.Rows(c - 1).Cells("CODPRODUCTODataGridViewTextBoxColumn1").Value
                    If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("DataGridViewTextBoxColumn1").Value) Then
                        CodCodigo = "NULL"
                    Else
                        CodCodigo = DetalleDevDataGridView.Rows(c - 1).Cells("DataGridViewTextBoxColumn1").Value
                    ...
                    If IsDBNull(DetalleDevDataGridView.Rows(c - 1).Cells("CANTIDADDEVUELTADataGridViewTextBoxColumn").Value) Then
                        CantidadDev = "NULL"
                    Else
                        CantidadDev = CDec(DetalleDevDataGridView.Rows(c - 1).Cells("CANTIDADDEVUELTADataGridViewTextBoxColumn").Value * -1)
                        CantidadDev = Replace(CantidadDev, ",", ".")
                    End If
                End If
                ...
                DescartarStock = DetalleDevDataGridView.Rows(c - 1).Cells("AumentarStock").Value
    ...
    Private Sub Anular()
        sql = ""
        sql = "UPDATE DEVOLUCIONDEBITOCOMPRA SET ESTADO = 2 , MOTIVOANULADO = '" & TxtMotivodeAnulacion.Text & "'  WHERE CODDEVOLUCION= " & DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCION").Value
    ...
    Private Sub tsPersonalizarDev_Click(sender As System.Object, e As System.EventArgs) Handles tsPersonalizarDev.Click
        ...
        ABMConfigPosExpress.abrirdesde("DevolucióndebitoCompra")
    End Sub
    ...
    Private Sub tsDuplicarFactura_Click(sender As System.Object, e As System.EventArgs) Handles tsDuplicarFactura.Click
        ...
        Else
            ...
            Dim MaxDev As Double = w.Maximo("CODDEVOLUCION", "DEVOLUCIONDEBITOCOMPRA")
...
todasfechas:
        ...
        Me.DEVOLUCIONDEBITOCOMPRATableAdapter.Fill(Me.DsDevolucionCompra.DEVOLUCIONDEBITOCOMPRA, fechaDesdeEspecial, fechaHastaEspecial)
        Try
            DEVOLUCIONDEBITOCOMPRADETALLETableAdapter.Fill(DsDevolucionCompra.DEVOLUCIONDEBITOCOMPRADETALLE, DevolucionesDataGridView.CurrentRow.Cells("CODDEVOLUCION").Value)
        Catch ex As Exception
        End Try
        ...
        If Trim(tsFiltroNroCliente.Text) <> "" Then
            DEVOLUCIONDEBITOCOMPRABindingSource.Filter = "NUMPROVEEDOR = " & Trim(tsFiltroNroCliente.Text)
        Else
            If Trim(tsFiltroNomCliente.Text) <> "" Then
                DEVOLUCIONDEBITOCOMPRABindingSource.Filter = "NOMBRE like '%" & Trim(tsFiltroNomCliente.Text) & "%'"
            End If
        End If
        lblDGVCant.Text = "Cant. de Items:" & DevolucionesDataGridView.RowCount
    End Sub
...
todoslosprod:
    ...
    Public Sub PintarCeldas()
        ...
        '    For i = 0 To DevolucionesDataGridView.RowCount - 1
        '        If DevolucionesDataGridView.Rows(i).Cells("ESTADODataGridViewTextBoxColumn").Value = 1 Then
        '            DevolucionesDataGridView.Item(0, i).Style.ForeColor = Color.Green
        '        ElseIf DevolucionesDataGridView.Rows(i).Cells("ESTADODataGridViewTextBoxColumn").Value = 2 Then
        '            DevolucionesDataGridView.Item(0, i).Style.ForeColor = Color.Maroon
        '        ElseIf DevolucionesDataGridView.Rows(i).Cells("ESTADODataGridViewTextBoxColumn").Value = 0 Then
