...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DSPeriodoFiscalForm"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DSPeriodoFiscalForm
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DSPeriodoFiscalForm = CType(MyBase.Clone, DSPeriodoFiscalForm)
        cln.InitVars()
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSPeriodoFiscalForm"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DSPeriodoFiscalForm.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DSPeriodoFiscalForm = New DSPeriodoFiscalForm()
    ...
    Partial Public Class PERIODOFISCALPRESUPUESTODataTable
        ...
        Public Overloads Function AddPERIODOFISCALPRESUPUESTORow(ByVal codpresupuestofiscal As Integer, ByVal parentperiodofiscalRowByperiodofiscal_PERIODOFISCALPRESUPUESTO As periodofiscalRow, ByVal parentplancuentasRowByplancuentas_PERIODOFISCALPRESUPUESTO As plancuentasRow, ByVal valor As Decimal) As PERIODOFISCALPRESUPUESTORow
            ...
            If (Not (parentplancuentasRowByplancuentas_PERIODOFISCALPRESUPUESTO) Is Nothing) Then
                columnValuesArray(2) = parentplancuentasRowByplancuentas_PERIODOFISCALPRESUPUESTO(2)
            End If
    ...
    Partial Public Class plancuentasDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Overloads Function AddplancuentasRow(ByVal NUMPLANCUENTA As String, ByVal DESPLANCUENTA As String, ByVal CODPLANCUENTA As Integer) As plancuentasRow
            Dim rowplancuentasRow As plancuentasRow = CType(Me.NewRow, plancuentasRow)
            Dim columnValuesArray() As Object = New Object() {NUMPLANCUENTA, DESPLANCUENTA, CODPLANCUENTA}
...
Namespace DSPeriodoFiscalFormTableAdapters
    ...
    Partial Public Class PERIODOFISCALPRESUPUESTOTableAdapter
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As DSPeriodoFiscalForm.PERIODOFISCALPRESUPUESTODataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As DSPeriodoFiscalForm.PERIODOFISCALPRESUPUESTODataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DSPeriodoFiscalForm.PERIODOFISCALPRESUPUESTODataTable = New DSPeriodoFiscalForm.PERIODOFISCALPRESUPUESTODataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataTable As DSPeriodoFiscalForm.PERIODOFISCALPRESUPUESTODataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataSet As DSPeriodoFiscalForm) As Integer
    ...
    Partial Public Class periodofiscalTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        periodofiscal.*" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM            periodofiscal"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, True)> _
        Public Overridable Overloads Function Fill(ByVal dataTable As DSPeriodoFiscalForm.periodofiscalDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = True) Then
                dataTable.Clear()
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], True)> _
        Public Overridable Overloads Function GetData() As DSPeriodoFiscalForm.periodofiscalDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DSPeriodoFiscalForm.periodofiscalDataTable = New DSPeriodoFiscalForm.periodofiscalDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataTable As DSPeriodoFiscalForm.periodofiscalDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
    ...
    Partial Public Class plancuentasTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [plancuentas] WHERE (((@IsNull_NUMPLANCUENTA = 1 AND [NUMPLANCUENTA] " & _
                ...
                "NTA)) AND ([CODPLANCUENTA] = @Original_CODPLANCUENTA))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [plancuentas] ([NUMPLANCUENTA], [DESPLANCUENTA], [CODPLANCUENTA]) VAL" & _
                "UES (@NUMPLANCUENTA, @DESPLANCUENTA, @CODPLANCUENTA);" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "SELECT NUMPLANCUENTA, DES" & _
                "PLANCUENTA, CODPLANCUENTA FROM plancuentas WHERE (CODPLANCUENTA = @CODPLANCUENTA" & _
                ")"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [plancuentas] SET [NUMPLANCUENTA] = @NUMPLANCUENTA, [DESPLANCUENTA] = @DES" & _
                "PLANCUENTA, [CODPLANCUENTA] = @CODPLANCUENTA WHERE (((@IsNull_NUMPLANCUENTA = 1 " & _
                "AND [NUMPLANCUENTA] IS NULL) OR ([NUMPLANCUENTA] = @Original_NUMPLANCUENTA)) AND" & _
                " ((@IsNull_DESPLANCUENTA = 1 AND [DESPLANCUENTA] IS NULL) OR ([DESPLANCUENTA] = " & _
                "@Original_DESPLANCUENTA)) AND ([CODPLANCUENTA] = @Original_CODPLANCUENTA));" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "SEL" & _
                "ECT NUMPLANCUENTA, DESPLANCUENTA, CODPLANCUENTA FROM plancuentas WHERE (CODPLANC" & _
                "UENTA = @CODPLANCUENTA)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT NUMPLANCUENTA, DESPLANCUENTA, CODPLANCUENTA FROM plancuentas"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, True)> _
        Public Overridable Overloads Function Fill(ByVal dataTable As DSPeriodoFiscalForm.plancuentasDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = True) Then
                dataTable.Clear()
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], True)> _
        Public Overridable Overloads Function GetData() As DSPeriodoFiscalForm.plancuentasDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DSPeriodoFiscalForm.plancuentasDataTable = New DSPeriodoFiscalForm.plancuentasDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataTable As DSPeriodoFiscalForm.plancuentasDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Private Function UpdateUpdatedRows(ByVal dataSet As DSPeriodoFiscalForm, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Private Function UpdateInsertedRows(ByVal dataSet As DSPeriodoFiscalForm, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._periodofiscalTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Private Function UpdateDeletedRows(ByVal dataSet As DSPeriodoFiscalForm, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._pERIODOFISCALPRESUPUESTOTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Overridable Function UpdateAll(ByVal dataSet As DSPeriodoFiscalForm) As Integer
