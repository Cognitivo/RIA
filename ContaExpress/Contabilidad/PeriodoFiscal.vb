...
'    Dim dsFiscal As New DsPeriodoFiscal()
'    Dim presupuesto As New DsPeriodoFiscalTableAdapters.PresupuestoFiscalTableAdapter()
...
'    Private Sub BtnEstablecerPeriodo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
...
'    Private Sub GridViewPeriodos_SelectionChanged(sender As Object, e As EventArgs) Handles GridViewPeriodos.SelectionChanged
'        Dim i As String = Me.GridViewPeriodos.CurrentRow.Cells(4).Value.ToString()
'        presupuesto.Fill(DsPeriodoFiscal.PresupuestoFiscal, Convert.ToInt16(i))
'        dgvPresupuestoFiscal.DataSource = presupuesto
'    End Sub

'    Private Sub dgvPresupuestoFiscal_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvPresupuestoFiscal.CellContentClick
